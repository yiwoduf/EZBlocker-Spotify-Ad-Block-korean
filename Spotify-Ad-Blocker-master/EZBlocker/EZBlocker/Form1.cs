...
namespace EZBlocker
{
    public partial class Main : Form
    {
        ...
        private void VolumeMixerButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("볼륨믹서를 열 수 없습니다. 윈도우 7/8/10 만 가능합니다.", "EZBlocker");
            }
        }
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            if (!hasNet45())
            {
                if (MessageBox.Show("넷프레임워크 4.5. 이 없습니다. 다운하시겠습니까?", "EZBlocker Error", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.Yes)
                {
                    Process.Start("https://www.microsoft.com/en-us/download/details.aspx?id=30653");
                } else
                {
                    MessageBox.Show("이지블로커는 넷프레임워크 없이 작동하지 않습니다.");
                }
            }
        ...
        private void BlockBannersCheckbox_CheckedChanged(object sender, EventArgs e)
        {
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            ...
            {
                var result = MessageBox.Show("이지블로커가 실행되고 있지 않을경우 스포티파이 광고가 차단되지 않습니다. \r\n\r\n정말로 종료하시겠습니까?", "EZBlocker",
